...
```{r}
obsdata= subset(keels, select=
                -c(Octopus_Tank,
                   Recording,
                   Moved.Out,
                   Burrower,
                   Comments), na.omit=na.pass
...
obsdata=data.frame(A=subset(obsdata[1:10,]),
                            B=subset(obsdata[11:20,]),
                            C=subset(obsdata[21:30,]),
                            D=subset(obsdata[31:40,])
                            )
                          
                            
  
  
icc(obsdata, model="twoway", type="agreement", unit="single")
```
