...
plot((unlist(keels))~days,data=keels.df,axes=F,ylab="",xlab="",type="n")
box(lwd=2)



points(keels~days,data=keels.df[keels.df$burrow=="yes"],
       pch=22,bg="white",col="blue",cex=1.5)

points(keels~days,data=keels.df[keels.df$burrow=="no"],
       pch=21,bg="white", col="red",cex=1.5)


lines(exp(seq.yes),exp(pred1.yes),col="blue",lwd=2,lty=2)
lines(exp(seq.no),exp(pred1.no),col="red",lwd=2,lty=2)
