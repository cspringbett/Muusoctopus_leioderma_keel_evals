...
#Get slopes
```{r}
burrowers.lm=lm(keel~days,data=keels.df[keels.df$burrow=="yes",]) # Burrowers
summary(burrowers.lm)

nonburrowers.lm=lm(keel~days,data=keels.df[keels.df$burrow=="no",])   # Non-burrowers
summary(nonburrowers.lm)
```
