...
d2<-keeldate$O2-keeldate$O1
d3<-keeldate$O3-keeldate$O2
d4<-keeldate$O4-keeldate$O3
d5<-keeldate$O5-keeldate$O4
```

```{r}
datedif<-matrix(c(d1,d2,d3,d4,d5), ncol=5)
rownames(datedif) = keeldate$Octopus_Tank
colnames(datedif) = c("O1-In","O2-O1","O3-O2","O4-O3","O5-O4")
```
