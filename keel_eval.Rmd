...
```{r}
keels.lme=lme(keel~days*burrow,random=~1|octo,
...
plot(keel~days,data=keels.df,axes=F,ylab="Burrowing Prominece",xlab="Days in Captivity",type="n")
box(lwd=2)
axis(1)
axis(2)
...
#points(keel~days,data=keels.df[keels.df$burrow=="yes",],
#       pch=22,bg="white",col="blue",cex=1.5)



points(keel~days,data=keels.df[keels.df$burrow=="no",],
       pch=21,bg="white", col="red",cex=1.5)

lines(keel~days,data=keels.df[keels.df$octo=="Brendon_CS4",],col="lightblue",lwd=0.4)
points(keel~days,data=keels.df[keels.df$octo=="Brendon_CS4",],
       pch=22,bg="blue",cex=1.5)

lines(keel~days,data=keels.df[keels.df$octo=="Jerry_CS2",],col="lightblue",lwd=0.4)
points(keel~days,data=keels.df[keels.df$octo=="Jerry_CS2",],
       pch=23,bg="blue",cex=1.5)

lines(keel~days,data=keels.df[keels.df$octo=="Oscar_CS3",],col="lightblue",lwd=0.4)
points(keel~days,data=keels.df[keels.df$octo=="Oscar_CS3",],
       pch=24,bg="blue",cex=1.5)

lines(keel~days,data=keels.df[keels.df$octo=="Jordan_CS4",],col="lightblue",lwd=0.4)
points(keel~days,data=keels.df[keels.df$octo=="Jordan_CS4",],
       pch=25,bg="blue",cex=1.5)


lines(keel~days,data=keels.df[keels.df$octo=="Amanda_CS2",],col="lightpink",lwd=0.4)
points(keel~days,data=keels.df[keels.df$octo=="Amanda_CS2",],
       pch=21,bg="red",cex=1.5)

lines(keel~days,data=keels.df[keels.df$octo=="Joe_CS1",],col="lightpink",lwd=0.4)
points(keel~days,data=keels.df[keels.df$octo=="Joe_CS1",],
       pch=22,bg="red",cex=1.5)

lines(keel~days,data=keels.df[keels.df$octo=="Naddlie_CS1",],col="lightpink",lwd=0.4)
points(keel~days,data=keels.df[keels.df$octo=="Naddlie_CS1",],
       pch=23,bg="red",cex=1.5)

lines(keel~days,data=keels.df[keels.df$octo=="Rian_CS5",],col="lightpink",lwd=0.4)
points(keel~days,data=keels.df[keels.df$octo=="Rian_CS5",],
...
#legend("topright", c(expression("Burrowers"),
                     #expression("Non-Burrowers")),
