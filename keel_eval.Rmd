...
plot(keel~days,data=keels.df,axes=F,ylab="",xlab="",type="n")
box(lwd=2)
axis(1)
axis(2)
...
lines(keel~days,data=keels.df[keels.df$octo=="Brendon_CS4",],col="lightblue",lwd=0.5)
...
#       pch = c(22,21),bty="n",title = expression("Treatment pCO"["2"]))
